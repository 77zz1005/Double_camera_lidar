...
private:
    string share_path;
    int ENEMY;
    string CAMERA_PARAM_0;
    string CAMERA_PARAM_1;
    string PASSWORD;
    string OnnxForArmor;
    string EngineForArmor;
    string CameraConfig_0;
    string CameraConfig_1;
    ...
    vector<SharedQueue<Mat>> myFrames = vector<SharedQueue<Mat>>(2);
...
private:
    ...
    void detectDepth(int camera_index, vector<bboxAndRect> &pred);        // add index
    void detectDepth(int camera_index, vector<ArmorBoundingBox> &armors); // add index
